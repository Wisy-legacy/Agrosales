...
const products=[
    {
        ...
        price: "#60,000/50kg",
        image: image1,
        description: "Freshly refined rice from local farms."
    },
    {
        name: "beans",
        price: "#4,000/bucket",
        image: image2,
        description: "Harvested beans for a healthy growth."
    },
    {
        name: "yam",
        price: "#2,500/tuber",
    ...
    },
    {
        ...
        price: "#8,000/5L",
        image: image6,
        description: "Freshly refined palmoil from local farms."
    }
    ,
    {
        name: "Groundnut oil",
        price: "#10,000/5L",
        image: image7,
        description: "Freshly refined groundnut oil from local farms."
    },
    {
        name: "Garri",
        price: "#3,000/paint",
        image: image8,
        description: "Freshly refined garri from local farms."
    },  
    {
        name: "Fertilizer",
        price: "#15,000/50kg",
        image: image9,
        description: "Buy your fertilizer."
    }  
]
   ...
   <>
    <div className='bg-lime-50 mb-0'>
        ...
        <div className='grid md:grid-cols-3 gap-2  mb-3'>
            {products.map((item) =>{
                return(  
                <div className= 'bg-green-300 rounded-2xl flex flex-col w-70 m-5 gap-1 text-center items-center transition-transform duration-300 hover:scale-105'>
